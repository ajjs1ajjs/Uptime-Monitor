...
При першому запуску генерується **випадковий пароль адміністратора** (16 символів).

Пароль буде показано в консолі та збережено в:
- **Linux:** `/etc/uptime-monitor/credentials.txt`
