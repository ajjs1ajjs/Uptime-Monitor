...
- **Вхід**: адмін
- **Пароль**: генерується автоматично (виводиться на екран наприкінці встановлення)
...
- [ ] **Змінити пароль за умовчанням** - КРИТИЧНО! (логін `admin`, пароль з виводу інсталяції)
...
- **Пароль:** випадковий (генерується при першій інсталяції та виводиться на екран)
